...
for cat in cat_array: 
    ...
    job_arr = []
    jobs_url = []
    template = "https://jpmc.fa.oraclecloud.com/hcmUI/CandidateExperience/en/sites/CX_1001/requisitions?lastSelectedFacet=CATEGORIES&location=India&locationId=300000000289360&locationLevel=country&mode=location&selectedCategoriesFacet={}"
    ...
    jobs =   wait(driver, 20).until(EC.presence_of_element_located((By.CLASS_NAME, "search-results-jobs-list")))
